...
DATA=load('G:\INS_LOOSE-master\pull_test_01.csv');
...
gyro_offsetx=sum(MMQ(5,30000:157000))/157000-30000;
gyro_offsety=sum(MMQ(6,30000:157000))/157000-30000;
gyro_offsetz=sum(MMQ(7,30000:157000))/157000-30000;
...
output=find_position(MMQ,initialState);
